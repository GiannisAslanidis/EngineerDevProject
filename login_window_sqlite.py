...
# Check login format using regex
    ...
    def login(self):
        ...
        with conn:
            cur.execute("SELECT * FROM users_info WHERE Username=:usern AND Password=:pass",{'usern':username,'pass':password})
        ...
        if (username=="" or password=="" or email=="" or phone_number=="" or first_name=="" or last_name==""):
            ...
            with conn:
                cur.execute("""INSERT INTO users_info ('Username','Password','Email','Phone_Number','First_Name','Last_Name')
                              VALUES('{}','{}','{}','{}','{}','{}')""".format(username,password,email,phone_number,first_name,last_name))
